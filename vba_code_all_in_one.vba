%% Calculate the number of position movements
...
---------------------------------------------------------------------
%% Calculate the number of changes of employment status and the number of position movements
...
End Sub
---------------------------------------------------------------------
%% Determine the status changes and find the last status:
...
End Sub
---------------------------------------------------------------------
%% Find the number of position movements for terminated subjects
...
End Sub
---------------------------------------------------------------------
%% Find subjects who worked as GRN or GRM, specifying those starting with such positions (GRN: ‘Graduated registered nurse’; GRM: ‘Graduated registered midwife’)
